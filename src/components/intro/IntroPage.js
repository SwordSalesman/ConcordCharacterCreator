...
function IntroPage() {
  ...
  return (
    <div>
      ...
      <br />
      <p>
        Follow the steps and fill in your character details. To save your
        character for later, and to submit your character to the team, you'll
        need to sign in on the top right. Your character won't be submitted
        until you click <i>submit</i> on the final step.
      </p>
      <br />
      <div>
