...
export function Gardens() {
	...
	const showAddHerbButton = unlockedHerbCount < allHerbCount && tutorialSettings.showUnlocks;
			...
			>
				<div className="grid grid-cols-2 gap-1 sm:grid-cols-3 select-none">
					...
					{showAddHerbButton ? (
						<div
							className={
								`animate-in fade-in flex min-h-24 items-center justify-center ${unlockedHerbCount % 2 === 0 ? "col-span-2 sm:col-span-1" : "col-span-1"}`
